...
2. [Install Catalan Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Catalan language pack](#3-how-to-active-hungarian-language-pack)
...
![language pack](http://progressed.io/bar/3?title=translated)
...
```
unzip master.zip app/i18n/Mageplaza/ca_es
```
...
## 3. How to active Catalan language pack {#active}
